...
function ui.init(parent)
	...
	-- Create Text_goldNum
	local Text_goldNum = GUI:Text_Create(Panel_1, "Text_goldNum", 73.00, 82.00, 14, "#ffffff", "$STM(ITEMCOUNT_金币)")
	GUI:Text_AutoUpdateMetaValue(Text_goldNum, "$STM(ITEMCOUNT_金币)")
