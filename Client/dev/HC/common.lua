...
if HC.is_client then
	...
	bodyitem = function(actor, index)
		...
		local makeindex = ItemObj.makeindex(actor, itemobj)
...
ItemStd = {
	...
	is_money = function(itemname) return ItemStd.index(itemname) <= 100 and ItemStd.stdmode(itemname) == 41 end,
	is_title = function(itemname) return ItemStd.stdmode(itemname) == 70 end
}
